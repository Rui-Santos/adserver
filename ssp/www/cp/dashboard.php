		...
		<div class="container">
			...
			<div class="grid-7">
				...
				<div id="gettingStarted" class="box">
					<h3>Adskom - Getting Started</h3>
					<p>We'll help you get up and running with Adskom in no time!</p>
			  ...
			  <div class="box">
				...
				<!--<ul class="bullet secondary">
						<li><a href="<?php echo "../../sdk/ios_latest.zip"; ?>">Adskom iOS SDK</a></li>
						<li><a href="<?php echo "../../sdk/android_latest.zip"; ?>">Adskom Android SDK</a></li>
