...
<div id="content">		
		...
		<div class="container">
            ...
            <div class="box plain"><div class="notify notify-error"><h3>Error</h3><p>Adskom was unable to connect to your MobFox Account. A valid MobFox connection is required for Adskom to function properly. If you have recently updated your MobFox Account password, please update your user credentials below.</p></div> <!-- .notify --></div>
            <?php } ?>
           <?php if ($updated==1){?>	
