		 		...
		 		<div id="menuProfile" class="menu-container menu-dropdown">
					<div class="menu-content">
						<ul class="">
            		 	...
            		 	<li><a target="_blank" href="http://help.adskom.com">Help</a></li>
            		 	<li><a target="_blank" href="http://help.adskom.com/reportbug.php">Feedback</a></li>
...
<div id="footer"><?php echo getconfig_var('adserver_name'); ?> - Adskom <?php echo MAD_VERSION; ?> - Server Time: <?php echo date('l jS F Y h:i:s A'); ?>
</div>
