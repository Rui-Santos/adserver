...
<div id="wrapper">
	...
	<div id="sidebar">		
		...
		<!--	<li id="navType" class="nav">
            ...
            <?php if ($user_detail['account_type']==1 or  ($user_right['yield_management']==1)){?>
			<li id="navInterface" class="nav<?php if ($current_section=="yield_management"){echo " active"; } ?>">
				<span class="icon-cog-alt"></span>
				<a href="yield_report.php">Yield Management</a>
                                <ul class="subNav">
					<li><a href="yield_report.php">Yield Report</a></li>					
					<li><a href="campaign_perf.php">Campaign Performance</a></li>					
					<li><a href="yield_management_setup.php">Setup</a></li>					
				</ul>	
