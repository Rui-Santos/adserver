...
<?php if (!isset($editdata['reporting_publication'])){$editdata['reporting_publication']='';} get_publication_dropdown_report($editdata['reporting_publication'], $user_detail['user_id']); ?>								</select>					
