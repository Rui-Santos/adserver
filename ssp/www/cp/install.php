...
<div id="content">		
		...
		<div id="contentHeader">
			<h1>Adskom Installation Wizard - Step <?php echo $mad_install['step']; ?></h1>
		</div> <!-- #contentHeader -->	
		...
		<div class="container">
            ...
            <?php if($mad_install['step']==1){ ?>
						...
						<h3>Adskom Server Check Failed</h3>
						
						<p>You are only one step away from running your very own instance of Adskom, world's most powerful mobile ad server. Adskom has performed some checks on your server and there are a couple of thing's you'll need to do before Adskom can be installed properly.</p>
					</div> <!-- .notify -->
                    <?php } else { ?>
                    <div class="notify notify-success">
						
						<a href="javascript:;" class="close">&times;</a>
                    <h3>Adskom Server Check Successful</h3>
						
						<p>Congratulations! You are only one step away from running your very own instance of Adskom, world's most powerful mobile ad server. The Server check has been successful. To continue with installation, please click the button below.</p>
					</div> <!-- .notify -->
                    <?php } ?>
            ...
            <?php if (!check_writeable(MAD_PATH . '/conf/')){ ?>
					...
					<div class="widget">			
						...
						<div class="widget-content">
							<p>This is the directory where Adskom will store creatives for ad-serving. In order to continue with installation, please make sure that the directory <strong><?php echo MAD_PATH; ?>/data/creative/</strong> is writeable. (eg. CHMOD 777)</p>
						</div>
                    ...
                    <div class="widget">			
						...
						<div class="widget-content">
							<p>Adskom has detected that your PHP version is lower than 5.3. If you would like to enable caching to speed up your Adskom ad server, you'll need to have PHP 5.3 or greater installed.</p>
						</div>
					...
					<div class="widget">			
						...
						<div class="widget-content">
							<p>If you'd like to enable File-Based caching to speed up your Adskom ad server, please make sure that the caching directory <strong><?php echo MAD_PATH; ?>/data/cache/</strong> is writeable. (eg. CHMOD 777)</p>
						</div>
                    ...
                    <div class="widget">			
						...
						<div class="widget-content">
							<p>It seems that the SimpleXML Extension is not loaded in your PHP Installation. Adskom requires SimpleXML, and you can find instructions on how to install it <a href="http://php.net/manual/en/book.simplexml.php" target="_blank">here.</a></p>
						</div> 
                        </div>
                    <?php } ?>		
                    ...
                    <div class="widget">			
						...
						<div class="widget-content">
							<p>Adskom requires the PHP mbstring extension to be installed for geo targeting. You can find instructions on how to install it <a href="http://php.net/manual/en/book.mbstring.php" target="_blank">here.</a></p>
						</div> 
                        </div>
                    <?php } ?>		
...
<div class="actions">						
            ...
            <?php } ?>
                ...
                <div class="notify notify-info">
						...
						<p>By adding your MobFox account details to Adskom, you will be able to easily monetize any un-filled traffic through the MobFox:Connect RTB exchange, get access to real-time traffic requests from over 30 different ad networks, download additional third party ad network modules right through Adskom.org, and get notified immediately about product & security updates from Adskom.</p>
					</div> <!-- .notify -->
                ...
                <div class="notify notify-success">
						...
						<p>Congratulations! Your Adskom installation has completed successfully and Adskom is now ready for production use. Please click the below button and log-in with the Administrator E-Mail and Password you supplied earlier in the installation process.</p>
					</div> <!-- .notify -->
