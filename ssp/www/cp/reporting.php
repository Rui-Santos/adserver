...
$log = Logger::getLogger('reporting.php');
...
<?php if ($report_active!=1){ ?>
    <script>
        $(function () { 
                ...
                $( "#startdatepicker" ).datepicker({ onSelect: function(dateText) { $("#startdate_value").val(dateText); } });
                $( "#enddatepicker" ).datepicker({ onSelect: function(dateText) { $("#enddate_value").val(dateText); } });
