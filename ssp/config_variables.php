...
function setupConstants()
{
	...
	define('MAD_PRODUCT_NAME',      'adskom');
	define('MAD_PRODUCT_URL',       'www.adskom.com');
	...
	// geo-ip settings
	define('MAD_MAXMIND_TYPE', 'NATIVE'); // Change to 'NATIVE' if you installed the GeoIP PHP Module (http://www.php.net/manual/en/book.geoip.php) -> Faster! - Please note that mAdserve will crash if this option is enabled but not installed.
