...
function ad_request($data){
    ...
    // need to be moved from db update to file processing
    update_last_request();
...
function set_geo($ip_address){
    ...
    case 'NATIVE':
        /* tirto -- fixed by changing to NATIVE and installed geoip package correctly 
           https://www.assembla.com/spaces/adskom/tickets/24 
         */
